...
RUN apk --update add chromium alsa-lib at-spi2-atk at-spi2-core atk cairo cups-libs dbus-libs eudev-libs expat ffmpeg-libs flac font-opensans fontconfig freetype glib gtk+3.0 harfbuzz lcms2 libatomic libdrm libevent libgcc libjpeg-turbo libpng libpulse libstdc++ libwebp libx11 libxcb libxcomposite libxdamage libxext libxfixes libxkbcommon libxml2 libxrandr libxslt mesa-gbm mkfontscale musl nspr nss opus pango re2 snappy wayland-libs-client xdg-utils zlib ca-certificates ttf-freefont pango-dev libxcursor libxscrnsaver libc6-compat gcompat libxshmfence
